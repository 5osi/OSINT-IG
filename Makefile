...
setup:
	...
	@echo -e "\e[34m####### Setup for OSINT IG #######\e[0m"
...
build-run-testing:
	...
	@echo -e "\e[34m######## Building and Running OsintIg with Docker-compose for Testing/Debugging ########\e[0m"
	@[ -d config ] || { echo -e "\e[31mConfig folder not found! Please run 'make setup' before running this command.\e[0m"; exit 1; }
	@echo -e "\e[34m[#] Killing old docker processes\e[0m"
	@docker-compose rm -fs || exit 1
	@echo -e "\e[34m[#] Building docker container\e[0m"
...
cleanup-testing:
	...
	@docker-compose down
	@echo -e "\e[32m[#] osintig-test container has been removed\e[0m"
